<?php
    ...
    define('EI_PHP_MINIMUM_VERSION', '5.6.8');
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define('EI_APPLICATION_NAME', 'System Management Project Localhost');
    // *** version number of your application 
    define('EI_APPLICATION_VERSION', 'v0.5');
