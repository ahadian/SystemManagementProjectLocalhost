...
$arrLang['alert_admin_name_wrong'] = "Admin name cannot be empty! Please re-enter.";
...
$arrLang['admin_name_info'] = "Admin Name that will be replaced in SQL dump with email placeholder (if defined).";
