...
################################################################################
	...
	if($task == 'send'){
		...
		if($admin_username == ''){
			...
			$error_msg = lang_key('alert_admin_name_wrong');				
		}else{
	...
	<div id="content">
		...
		<div class="central-part">
			...
			<tr>
				...
				<td><input name="admin_name" id="admin_name" class="form_text" size="28" maxlength="125" value="<?php echo $admin_name; ?>" onfocus="textboxOnFocus('notes_admin_name')" onblur="textboxOnBlur('notes_admin_name')" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> /></td>
			</tr>
